describe('Main page', () => {
  ...
  it('should display the expected elements', function () {
    ...
    cy.get('[data-testid="Totals-Header"]').should('be.visible').and('have.text', 'Totals')    
    ...
    cy.get('[data-testid="BBBBB-Header"]').should('be.visible').and('have.text', 'BBBBB')    
    cy.xpath('//h1[@data-testid="BBBBB-Header"]/following::*[@class="recharts-responsive-container"][1]').should('be.visible')
    cy.xpath('//h1[@data-testid="BBBBB-Header"]/following::*[@class="recharts-responsive-container"][1]').click()
    cy.get('[class="recharts-tooltip-label"]').should('be.visible').and('contain.text', '1')
